...
public class TypeT : MyBasePrintClass
{
    ...
    public void Test1()
    {
        ...
        WriteLine($"a.Type: {type1}");

        //方式二：通过 typeof 关键字
        Type type2 = typeof(int);
        WriteLine($"int.Type: {type2}");

        //方式三：Type.GetType(类名字符串);
        //类名字符串必须包含 “命名空间”
        Type? type3 = Type.GetType("System.Int32");
        WriteLine($"Type: {type3}");

        //type.Assembly 获取所在程序集
        WriteLine($"type 所在程序集为: {type1.Assembly}");
    }
    ...
    public void Test3()
    {
        ...
        WriteLine($"无参构造器 obj.str: {obj1.str}");
        ...
        WriteLine($"有参构造器 obj.str: {obj2.str}");
    }
    ...
    public void Test5()
    {
        ...
        WriteLine(methodInfo.Invoke(obj, null).ToString());

        methodInfo = type.GetMethod("Speak", new Type[1] { typeof(string) });
        WriteLine(methodInfo.Invoke(obj, new[] { "Hello" }).ToString());
    }
